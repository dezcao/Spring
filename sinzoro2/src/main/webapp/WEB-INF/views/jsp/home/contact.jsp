...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <p><b>좋은 사람들과 함께하는 삶.</b></p>
            <p>
                    아파도, 고단해도 좋은 사람들과 함께 할때는 그게 힘든줄 몰랐던것 같습니다.
                <br>힘이 덜 들면 더 오래 할 수 있게 되고, 오래 하면 그 일을 더 잘하게 됩니다.
                <br>격려와 따듯한 태도를 가진 이들과 함께하는 것만으로도 더 좋은 프로그래머가 되는겁니다.
                <br>
                    ...
                    <ul>
                        <li><b>2017.10 - SK C&C Swing project</b>
                            <ul>
                                ...
                                <li>기타 화면개발</li>
                                <li>코딩 리더 부재, Spaghetti code.
                                    <ul>
                                        <li>과업중심의 프로젝트 리더 : 잠재적으로 일정에 영향을 줄수 있는 의뢰에는 부정적 태도.</li>
                                        <li>어떤 코드 리팩토링 작업도 하지 않음. spring 도입 후, 나오던 화면이 그대로 나오는데만 집중.</li>
                                        <li>explorer9 이외에선 무조건 화면이 깨지며, HTML에 Style 범벅인 기존의 디자인과 로직등 거의 그대로 유지.</li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
